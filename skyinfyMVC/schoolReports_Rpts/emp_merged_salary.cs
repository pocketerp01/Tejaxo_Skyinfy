...
namespace skyinfyMVC.schoolReports_Rpts {
    ...
    public class emp_merged_salary : ReportClass {
        
        public emp_merged_salary() {
        }
        
        public override string ResourceName {
            get {
                return "emp_merged_salary.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "skyinfyMVC.schoolReports_Rpts.emp_merged_salary.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedemp_merged_salary : Component, ICachedReport {
        
        public Cachedemp_merged_salary() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            emp_merged_salary rpt = new emp_merged_salary();
            rpt.Site = this.Site;
            return rpt;
        }
