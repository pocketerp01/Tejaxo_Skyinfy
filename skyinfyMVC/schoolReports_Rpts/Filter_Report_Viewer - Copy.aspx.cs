...
public partial class erp_schoolReports_Rpts_Filter_Report_Viewer1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["Data"] != null)
        {
            ...
            if (Session["fee_summary"] != null)
            {
                dt3 = (DataTable)Session["fee_summary"];
            ...
            string Rpt = (string)Session["Report"];
            ...
            //            //{
            //            txtobj1 = (TextObject)ReportDocument.ReportDefinition.ReportObjects["txtcp"];
