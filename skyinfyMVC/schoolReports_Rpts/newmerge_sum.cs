...
namespace skyinfyMVC.erp.schoolReports_Rpts {
    ...
    public class newmerge_sum : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "skyinfyMVC.erp.schoolReports_Rpts.newmerge_sum.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachednewmerge_sum : Component, ICachedReport {
        
        public Cachednewmerge_sum() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            newmerge_sum rpt = new newmerge_sum();
            rpt.Site = this.Site;
            return rpt;
        }
