...
namespace skyinfyMVC.schoolReports_Rpts {
    ...
    public class projection_rpt2 : ReportClass {
        
        public projection_rpt2() {
        }
        
        public override string ResourceName {
            get {
                return "projection_rpt2.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "skyinfyMVC.schoolReports_Rpts.projection_rpt2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedprojection_rpt2 : Component, ICachedReport {
        
        public Cachedprojection_rpt2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            projection_rpt2 rpt = new projection_rpt2();
            rpt.Site = this.Site;
            return rpt;
        }
