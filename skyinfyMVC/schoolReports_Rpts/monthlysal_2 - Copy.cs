...
namespace skyinfyMVC.erp.schoolReports_Rpts {
    ...
    public class monthlysal_2 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "skyinfyMVC.erp.schoolReports_Rpts.monthlysal_2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedmonthlysal_2 : Component, ICachedReport {
        
        public Cachedmonthlysal_2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            monthlysal_2 rpt = new monthlysal_2();
            rpt.Site = this.Site;
            return rpt;
        }
