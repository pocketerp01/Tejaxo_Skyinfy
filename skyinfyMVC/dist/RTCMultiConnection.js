...
var RTCMultiConnection = function(roomid, forceOptions) {
    ...
    function SocketConnection(connection, connectCallback) {
        ...
        if (connection.socketURL.substr(connection.socketURL.length - 1, 1) != 'https://rtcmulticonnection.herokuapp.com/') {
            // connection.socketURL = 'https://domain.com:9001/';
            throw '"socketURL" MUST end with a slash.';
        }

        if (connection.enableLogs) {
            if (connection.socketURL == 'https://rtcmulticonnection.herokuapp.com/') {
    ...
    // --------------------------------------------------
    // Muaz Khan     - www.MuazKhan.com
    // MIT License   - wwwx-Experiment.com/licence
    // --------------------------------------------------
    ...
    (function() {
        ...
        function getBrowserInfo() {
            ...
            if (isOpera) {
                browserName = 'Opera';
                try {
                    fullVersion = navigator.userAgent.split('OPR/index.html')[1].split(' ')[0];
            ...
            // In Safari, the true version is after 'Safari' or after 'Version' 
                ...
                if (navigator.userAgent.indexOf('Version/index.html') !== -1) {
                    fullVersion = navigator.userAgent.split('Version/index.html')[1].split(' ')[0];
                }
            }
            ...
            else if ((nameOffset = nAgt.lastIndexOf(' ') + 1) < (verOffset = nAgt.lastIndexOf('https://rtcmulticonnection.herokuapp.com/'))) {
            ...
            if (isEdge) {
                browserName = 'Edge';
                fullVersion = navigator.userAgent.split('Edge/index.html')[1];
    ...
    (function(connection) {
        ...
        connection.socketURL = 'https://rtcmulticonnection.herokuapp.com/'; // generated via config.json
