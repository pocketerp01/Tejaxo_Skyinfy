...
function addNewMessage(args) {
    ...
    userinfoDIV.innerHTML = args.userinfo || '<img src="../dist/images/user.png">';
...
main.querySelector('#continue').onclick = function() {
    ...
    addNewMessage({
        ...
        userinfo: '<img src="../dist/images/action-needed.png">'
    });
...
getElement('.main-input-box textarea').onkeyup = function(e) {
    ...
    addNewMessage({
        ...
        userinfo: getUserinfo(rtcMultiConnection.blobURLs[rtcMultiConnection.userid], '../dist/images/chat-message.png'),
