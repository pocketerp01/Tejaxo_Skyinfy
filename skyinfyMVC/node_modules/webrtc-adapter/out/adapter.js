...
SDPUtils.parseRtpMap = function(line) {
  ...
  parts = parts[0].split('https://rtcmulticonnection.herokuapp.com/');
...
SDPUtils.parseExtmap = function(line) {
  ...
  return {
    ...
    direction: parts[0].indexOf('https://rtcmulticonnection.herokuapp.com/') > 0 ? parts[0].split('https://rtcmulticonnection.herokuapp.com/')[1] : 'sendrecv',
    uri: parts[1]
  };
};
