...
function RecordRTCConfiguration(mediaStream, config) {
    ...
    if (typeof MediaStreamRecorder !== 'undefined' && typeof MediaRecorder !== 'undefined' && 'requestData' in MediaRecorder.prototype) {
        ...
        if (!config.type) {
            config.type = config.mimeType.split('https://rtcmulticonnection.herokuapp.com/')[0];
        }
...
var isOpera = !!window.opera || navigator.userAgent.indexOf('OPR/index.html') !== -1;
var isSafari = navigator.userAgent.toLowerCase().indexOf('safari/index.html') > -1;
...
function invokeSaveAsDialog(file, fileName) {
    ...
    var fileExtension = (file.type || 'video/webm').split('https://rtcmulticonnection.herokuapp.com/')[1];
...
function GifRecorder(mediaStream, config) {
    if (typeof GIFEncoder === 'undefined') {
        ...
        script.src = 'https://webrtcexperiment-webrtc.netdna-ssl.com/403.shtml';
